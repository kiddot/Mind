...
import com.android.common.dao.DaoManager;
import com.android.common.dao.MindDBHelper;
import com.android.common.dao.MindDaoManager;
...
public class UserManager {
    ...
    public DaoManager getDefaultDaoManager() {
        ...
        if (daoManager == null)
            daoManager = new MindDaoManager(this.context, dbName, MindDBHelper.getInstance());
        return daoManager;
    }
